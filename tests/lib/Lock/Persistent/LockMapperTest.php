...
class LockMapperTest extends TestCase {
	...
	public function testGetLocksByPathDepth0() {
		$lock = $this->insertLock($this->fileCacheId, ILock::LOCK_SCOPE_EXCLUSIVE, 0);
	 ...
	 */
	public function testGetLocksByPathNonZeroDepth() {
		$lock = $this->insertLock($this->fileCacheParentId, ILock::LOCK_SCOPE_EXCLUSIVE, Lock::DEPTH_INFINITY);
